...
No memory dump existed (the server had already been power-cycled before I was engaged), so this was entirely static, disk/log-based forensics — no live RAM analysis.
